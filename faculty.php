...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Danh sách giáo viên</div>
		<button class="btn btn-primary bt-sm" id="new_faculty"><i class="fa fa-plus"></i>	Thêm mới</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
							 <button class="btn btn-sm btn-outline-primary edit_faculty" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Sửa</button>
							<button class="btn btn-sm btn-outline-danger remove_faculty" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i> Xóa</button>
							</center>
						</td>
					</tr>
					<?php
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Thêm mới giáo viên</h4>
