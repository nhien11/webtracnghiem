...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Danh sách câu hỏi</div>
		<button class="btn btn-primary bt-sm" id="new_quiz"><i class="fa fa-plus"></i>	Thêm mới</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
							 <a class="btn btn-sm btn-outline-primary edit_quiz" href="./quiz_view.php?id=<?php echo $row['id']?>"><i class="fa fa-task"></i> Quản lí</a>
							 <button class="btn btn-sm btn-outline-primary edit_quiz" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Sửa</button>
							<button class="btn btn-sm btn-outline-danger remove_quiz" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i> Xóa</button>
							</center>
						</td>
					</tr>
					<?php
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Thêm mới</h4>gggf
						...
						<form id='quiz-frm'>
							<div class ="modal-body">
								...
								<div class="form-group">
									...
									<option value="" selected="" disabled="">Duc Tien</option>
									<?php
