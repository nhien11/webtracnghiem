...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Danh sách bài kiểm tra</div>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td><?php echo $status->num_rows > 0 ? 'đã làm' : 'Chưa làm' ?></td>
						<td>
							<center>
							 	<?php if($status->num_rows <= 0): ?>
							 	<a class="btn btn-sm btn-outline-primary" href="./answer_sheet.php?id=<?php echo $row['id']?>"><i class="fa fa-pencil"></i> Làm bài kiểm tra</a>
								<?php else: ?>
								<a class="btn btn-sm btn-outline-primary" href="./view_answer.php?id=<?php echo $row['id']?>"><i class="fa fa-eye"></i> Xem</a>
							<?php endif; ?>
							</center>
						</td>
					</tr>
