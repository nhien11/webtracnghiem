...
<body>
	...
	<div class="container-fluid admin">
		...
		<button class="btn btn-primary bt-sm" id="new_question"><i class="fa fa-plus"></i>	Thêm câu hỏi</button>
		<button class="btn btn-primary bt-sm" id="new_student"><i class="fa fa-plus"></i>	Thêm học sinh</button>
		<br>
		<br>
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Thêm mới câu hỏi</h4>
						...
						<form id='question-frm'>
							<div class ="modal-body">
								...
								<div class="form-group">
									...
									<span>
									<label><input type="radio" name="is_right[0]" class="is_right" value="1"> <small>Chọn đáp án</small></label>
									</span>
									<br>
									<textarea rows="2" name ="question_opt[1]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[1]" class="is_right" value="1"> <small>Chọn đáp án</small></label>
									<br>
									<textarea rows="2" name ="question_opt[2]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[2]" class="is_right" value="1"> <small>Chọn đáp án</small></label>
									<br>
									<textarea rows="2" name ="question_opt[3]" required="" class="form-control" ></textarea>
									<label><input type="radio" name="is_right[3]" class="is_right" value="1"> <small>Chọn đáp án</small></label>
								</div>
								
							</div>
							<div class="modal-footer">
								<button  class="btn btn-primary" name="save"><span class="glyphicon glyphicon-save"></span> Lưu</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="modal-dialog modal-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title" id="myModallabel">Thêm mới học sinh</h4>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						</div>
						<form id='student-frm'>
							<div class ="modal-body">
