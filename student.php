...
<body>
	...
	<div class="container-fluid admin">
		<div class="col-md-12 alert alert-primary">Danh sách học sinh</div>
		<button class="btn btn-primary bt-sm" id="new_student"><i class="fa fa-plus"></i>	Thêm mới</button>
		<br>
		<br>
		<div class="card">
			<div class="card-body">
				<table class="table table-bordered" id='table'>
					...
					<tr>
						...
						<td>
							<center>
							 <button class="btn btn-sm btn-outline-primary edit_student" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i> Sửa</button>
							<button class="btn btn-sm btn-outline-danger remove_student" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i> Xóa</button>
							</center>
						</td>
					</tr>
					<?php
